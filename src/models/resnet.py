"""
ResNet-18 and ResNet-34 ANN for ANN-to-SNN conversion experiments.

Uses standard BasicBlock structure with BatchNorm.
Skip connections are supported by SpikingJelly's conversion pipeline.
"""
...
class ResNet(nn.Module):
    def __init__(
        ...
        # Stem: smaller kernel for CIFAR-scale inputs
